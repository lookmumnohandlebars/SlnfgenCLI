...
public class ProjectFileTests
{
    ...
    {
        var proj = ProjectFile.LoadFromFile(
            Path.Combine(Directory.GetCurrentDirectory(), "TestSolution", "ProjA", "ProjA.csproj")
        );
        proj.FullPath.Should()
            .Be(Path.Combine(Directory.GetCurrentDirectory(), "TestSolution", "ProjA", "ProjA.csproj"));
